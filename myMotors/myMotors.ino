 ...
 */
 ...
 void messageCb( const std_msgs::String& timmy_msg) {
   ...
   else if (strcmp(timmy_msg.data, "right") == 0) {
     digitalWrite(dirPin1, HIGH);
     analogWrite(speedPin1, 255); 
   }
   else if (strcmp(timmy_msg.data, "fwd") == 0) {
     digitalWrite(dirPin1, HIGH);
     analogWrite(speedPin1, 160); // lower max
     digitalWrite(dirPin2, HIGH);
     analogWrite(speedPin2, 255); // higher max
   }
   else if (strcmp(timmy_msg.data, "ffwd") == 0) {
     digitalWrite(dirPin1, HIGH);
     analogWrite(speedPin1, 255);
     digitalWrite(dirPin2, HIGH);
     analogWrite(speedPin2, 255);
   }
   else if (strcmp(timmy_msg.data, "fwdl") == 0) {
     digitalWrite(dirPin1, HIGH);
     analogWrite(speedPin1, 160);
     digitalWrite(dirPin2, HIGH);
     analogWrite(speedPin2, 128);
   }
   else if (strcmp(timmy_msg.data, "fwdr") == 0) {
     digitalWrite(dirPin1, HIGH);
     analogWrite(speedPin1, 80);
     digitalWrite(dirPin2, HIGH);
     analogWrite(speedPin2, 255);
   }
   else if (strcmp(timmy_msg.data, "bwd") == 0) {
     digitalWrite(dirPin1, LOW);
     analogWrite(speedPin1, 255); // higher max
     digitalWrite(dirPin2, LOW);
     analogWrite(speedPin2, 160); // lower max
   }
   else if (strcmp(timmy_msg.data, "bbwd") == 0) {
     digitalWrite(dirPin1, LOW);
     analogWrite(speedPin1, 255);
     digitalWrite(dirPin2, LOW);
     analogWrite(speedPin2, 255);
   }
   else if (strcmp(timmy_msg.data, "bwdl") == 0) {
     digitalWrite(dirPin1, LOW);
     analogWrite(speedPin1, 255);
     digitalWrite(dirPin2, LOW);
     analogWrite(speedPin2, 80);
   }
   else if (strcmp(timmy_msg.data, "bwdr") == 0) {
     digitalWrite(dirPin1, LOW);
     analogWrite(speedPin1, 128);
     digitalWrite(dirPin2, LOW);
     analogWrite(speedPin2, 160);
   }
   else if (strcmp(timmy_msg.data, "pivotl") == 0) {
     digitalWrite(dirPin1, LOW);
     analogWrite(speedPin1, 255);
     digitalWrite(dirPin2, HIGH);
     analogWrite(speedPin2, 255);
   }
   else if (strcmp(timmy_msg.data, "pivotr") == 0) {
     digitalWrite(dirPin1, HIGH);
     analogWrite(speedPin1, 255);
     digitalWrite(dirPin2, LOW);
     analogWrite(speedPin2, 255);
   }
   else if (strcmp(timmy_msg.data, "stop") == 0) {
     digitalWrite(dirPin1, HIGH);
     analogWrite(speedPin1, 0);
     digitalWrite(dirPin2, HIGH);
     analogWrite(speedPin2, 0);
   }
   else if (strlen(timmy_msg.data) == 14 && timmy_msg.data[0] == 'c') { // custom speed
